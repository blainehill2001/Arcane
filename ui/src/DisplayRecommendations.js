          ...
          <div>
            {recommendations.length > 0 && (
              <div class="mx-8 my-4 px-4 py-4 ring ring-transparent rounded-lg bg-green-700">
                <p class="text-xs sm:text-sm md:text-base lg:text-lg p-2">
                  If you're not a fan of a recommendation, select to remove it!
                </p>
                    ...
                    return (
                      <div class="container mx-auto w-1/2 lg:w-1/5 md:w-1/3 p-3">
                        <button
                          ...
                          key={track.id}
                          onClick={() =>
                            deleteRecommendation(recommendations, track)
                          }
                        >
                          <img
